...
export const RECEIVE_INFO ='receive_info';//接受mock数据中的商品信息
export const RECEIVE_RATINGS ='receive_ratings';//接受mock数据中的商品评价
export const RECEIVE_GOODS ='receive_goods';//接受mock数据中的商品列表
...
export const RECEIVE_SEARCH_SHOPS ='receive_search_shops';//接受搜索的商家信息
