      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picUl">
            <li class="pic-item" v-for="(img, index) in info.pics" :key="index">
              <img width="120" height="90" v-lazy="img" />
            </li>
          </ul>
        </div>
      </section>
...
export default {
  setup() {
    ...
    return { info, supportClasses, picUl };
  },
};
</script>
