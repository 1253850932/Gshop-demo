    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch " :class="{on:onlyShowText}" @click="toggleOnlyShowText">
          <svg class="icon one iconfont icon-check_circle" aria-hidden="true">
...
export default {
  ...
  setup(props) {
	...
	const onlyShowText = ref(true) //是否显示有文本的
	const selectType = ref(2) //选择的评价类型：0 满意，1 不满意，2 全部
    onMounted(() => {	
	...
	const filterRatings = computed(()=>{
		return ratings.value.filter(rating => {
			...
			return (selectType.value ===2|| selectType.value ===rateType) && (!onlyShowText.value || text.length >0)
		})
	})
    ...
    return { info, ratings, ratingList,onlyShowText,selectType,toggleOnlyShowText,setSelectType,positiveSize,filterRatings,formatTime };
  },
};
</script>
